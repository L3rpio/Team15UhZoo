...
if (isset($_POST['update_profile'])) {
    ...
    mysqli_query($conn, "UPDATE `customer` SET user_name = '$update_username', email = '$update_email' WHERE customer_id = '$user_id'") or die('query failed');
    ...
    if (!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass)) {
        if ($update_pass != $old_pass) {
            ...
            mysqli_query($conn, "UPDATE `customer` SET pass_word = '$confirm_pass' WHERE customer_id = '$user_id'") or die('query failed');
    ...
    if (!empty($update_image)) {
        if ($update_image_size > 2000000) {
            ...
            $image_update_query = mysqli_query($conn, "UPDATE `customer` SET image = '$update_image' WHERE customer_id = '$user_id'") or die('query failed');
...
<body>
    ...
    <section class="profile-section">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            echo '<h3>' . $fetch['first_name'] . " " . $fetch['last_name'] . '</h3>';
